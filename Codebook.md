Codebook
========
As per the programming assignment, this code book describes the variables, the data, and any transformations or work that got performed to clean up the data.
...
Save data table objects to a tab-delimited text file called ` TidyData.txt `. File is stored (as standard) in the working directory.
